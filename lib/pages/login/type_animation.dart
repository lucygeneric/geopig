...
class PigTyperAnimatedTextKit extends StatefulWidget {
  ...
  final Function shouldResetDelegate;
  final Function onRewind;

  const PigTyperAnimatedTextKit({
    Key key,
    @required this.text,
    this.textStyle,
    this.onTap,
...
class _TyperState extends State<PigTyperAnimatedTextKit>
  ...
  void rewind() {
    ...
    _controller.reset();
    if (widget.onRewind != null) widget.onRewind();
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (currentText.join("-") != widget.text.join("-")){
